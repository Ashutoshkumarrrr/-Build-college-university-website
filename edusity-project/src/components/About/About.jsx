...
const About = ({setPlayState}) => {
    ...
    <div className='about'>
        ...
        <div className="about-right">
            ...
            <p>Embark on a transformative educational journary with our university's comprehensive education programs.Our cutting-edge curriculam is designed to empower students with the knowledge, skills,and expriences needed to excel in the dynamic filed of education.</p>
